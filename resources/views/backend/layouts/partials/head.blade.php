...
<script src="{{ URL::to('assets/AdminLTE-3.1.0/plugins/jquery/jquery.min.js') }} "></script>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{ URL::to('assets/AdminLTE-3.1.0/plugins/jqvmap/jqvmap.min.css') }} ">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ URL::to('assets/AdminLTE-3.1.0/dist/css/adminlte.min.css') }} ">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{ URL::to('assets/AdminLTE-3.1.0/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }} ">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ URL::to('assets/AdminLTE-3.1.0/plugins/daterangepicker/daterangepicker.css') }} ">
  <!-- summernote -->
  <link rel="stylesheet" href="{{ URL::to('assets/AdminLTE-3.1.0/plugins/summernote/summernote-bs4.min.css') }} ">
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ URL::to('assets/AdminLTE-3.1.0/plugins/jquery-ui/jquery-ui.min.js') }}  "></script>
...
<script src="{{ URL::to('assets/AdminLTE-3.1.0/dist/js/demo.js') }}  "></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ URL::to('assets/AdminLTE-3.1.0/dist/js/pages/dashboard.js') }}  "></script>
